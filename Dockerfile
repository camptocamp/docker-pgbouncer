...
ENV         DEBIAN_FRONTEND=noninteractive \
            ...
            PGBOUNCER_MD5SUM=b57212a12ba58fe11e934ea2e40bd610


RUN         set -x \
            && apt-get -qq update \
            && apt-get install -yq --no-install-recommends openssl ca-certificates libevent-2.1-7 libpam0g libssl1.1 libc-ares2 libpq5 \
            ...
            && wget https://github.com/pgbouncer/pgbouncer/releases/download/pgbouncer_1_17_0/pgbouncer-1.17.0.tar.gz \
            && md5sum pgbouncer-1.17.0.tar.gz | grep ${PGBOUNCER_MD5SUM} \
            && tar xf pgbouncer-1.17.0.tar.gz \
            && cd pgbouncer-1.17.0 \
            ...
            && apt-get clean \
            && cd .. && rm -rf pgbouncer-1.17.0 pgbouncer-1.17.0.tar.gz
